...
const Home = () => {
    return (
        <div className="w-full h-full flex justify-center items-center relative bg-white ">
            <div className="max-w-[70%] w-full h-full flex relative">
                <LeftMenu />
                <Main />
                <section className="w-[40%] sticky top-2 flex flex-col items-stretch h-screen px-6 mt-2  right-40 overflow-scroll scroll-hidden">
                    <div>
                    ...
                    <div className="flex flex-col rounded-xl border-neutral-200 border-[0.5px]  my-4">
                        ...
                        <div>
                            {
                                Array.from({length: 6}).map((_, item) => (
                                    <div key={item} className="hover:bg-black/5 transition duration-200 p-4 flex items-center justify-between ">
                                        ...
                                        <div className="">
                                            <button className="rounded-full px-6 py-2 bg-black text-white hover:bg-white hover:text-black transition duration-200 hover:rounded-1">Follow
                                            </button>
                                        </div>
                                    </div>
                                ))
