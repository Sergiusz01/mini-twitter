...
const Logout = ({ imageUrl, username, name }: Props) => {
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="max-xl:p-3 xl:py-2 xl:px-5 rounded-full hover:bg-black-200 transition flex items-center gap-x-2 cursor-pointer !outline-none !w-full">
